<template>
  <v-container>
    <div class="hide-on-review">
      <h2 class="pb-8">Before you begin operating, please check all that apply</h2>
      <hr class="orange" />
    </div>
    ...
    <div class="question-series">
      ...
      <div class="questions">
        <p
          class="hide-on-review"
        >Forestry Sector operators must be able to provide accommodations that minimize crowding, social interactions, and provide sufficient physical distance (individual tents or beds 2m apart and head-to-toe in shared accommodations).</p>
    ...
    <div class="question-series">
      ...
      <div class="questions">
        <p
          class="hide-on-review"
        >Helping workers to engage in hand hygiene prevents or reduces the spread of COVID-19 and other illnesses. Forestry Sector operators should ensure easy access to hand hygiene facilities either through hand hygiene stations or the provisions of hand sanitizer at the work site and at the accommodation site.</p>
        <v-checkbox
