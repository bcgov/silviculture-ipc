<template>
  <v-container>
    ...
    ></v-checkbox>
    <v-checkbox :readonly="reviewMode">
    ...
    <v-checkbox :readonly="reviewMode" label="I have laundry services available for regular use"></v-checkbox>
    ...
    <v-checkbox :readonly="reviewMode" label="I have disposable gloves for the handling of garbage"></v-checkbox>
    <v-checkbox :readonly="reviewMode" label="I have a waste removal schedule"></v-checkbox>
    <v-checkbox :readonly="reviewMode" label="I have sturdy, leak resistant garbage bags"></v-checkbox>
    ...
    ></v-checkbox>
    <v-checkbox :readonly="reviewMode" label="There is an appropriate supply of soap and water "></v-checkbox>
    <v-checkbox
      :readonly="reviewMode"
      label="I have supplemented with waterless hand sanitizers with a min of 60% alcohol where appropriate"
    ></v-checkbox>
    <v-checkbox :readonly="reviewMode" label="I have provided disposable paper towels"></v-checkbox>
    <v-checkbox :readonly="reviewMode" label="I have put up signs to promote regular hand washing"></v-checkbox>
