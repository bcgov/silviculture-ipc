<template>
  <v-container class="dashboard text-center">
    <BaseSecure inspector>
      <div v-if="inspectionDashboardUrl" class="dashboard-container">
        <iframe :src="inspectionDashboardUrl" />
      </div>
      <div v-else>
...
export default {
  ...
  computed: {
    inspectionDashboardUrl() {
      return this.$config ? this.$config.inspectionDashboardUrl : undefined;
    }
  }
};
</script>
